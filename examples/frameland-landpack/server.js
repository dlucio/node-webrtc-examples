...
const HANDS_HOST = process.env.HANDS_HOST || "localhost";
const HANDS_PORT = process.env.HANDS_PORT || "50055";
const frameland = grpc.loadPackageDefinition(packageDefinition).frameland;
const handDetectionClient = new frameland.HandDetection(`${HANDS_HOST}:${HANDS_PORT}`, grpc.credentials.createInsecure());

console.log(`Connected to hand detection service on: ${HANDS_HOST}:${HANDS_PORT}`);
